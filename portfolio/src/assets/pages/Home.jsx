        ...
        <>
            ...
            <main className="text-light-gray p-10 custom:flex custom:space-x-20 ">
                <div className="custom:w-1/2">
                    ...
                    <div className="flex flex-col space-y-2 text-gray-purple font-mono custom:w-1/2">
                        <a
                            href="mailto:zkary-raymond@live.fr"
                            className="flex items-center space-x-2 hover:text-white/80 custom:w-fit">
                        ...
                        <a
                            ...
                            className="flex items-center space-x-2 hover:text-white/80 w-fit">
